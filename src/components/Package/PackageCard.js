  ...
  return (
    ...
    >
      <div className="package-card-header">
        ...
        <Tag color={categoryColors[pkg.category]}>
      ...
      <div className="package-details">
        <div className="package-quota">
          <span className="quota-value">{pkg.quota}</span>
          <span className="quota-label">Kuota</span>
        </div>
        <div className="package-duration">
          <span className="duration-value">{pkg.duration}</span>
